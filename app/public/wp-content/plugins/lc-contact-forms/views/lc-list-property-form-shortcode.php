...
function html_list_property_form_code() {
	...
	if ( $form_submitted ) {
		...
		echo '<option title="' . esc_html__( 'Full Vacation Rental Online Solution Package, 5-10%', 'lc-contact-forms' ) . '" value="' . esc_html__( 'Full Vacation Rental Online Solution Package, 5-10', 'lc-contact-forms' ) . '">' . esc_html__( 'Full Vacation Rental Online Solution Package, 5-10%', 'lc-contact-forms' ) . '</option>';
		echo '</select>';
		echo '</p>';
