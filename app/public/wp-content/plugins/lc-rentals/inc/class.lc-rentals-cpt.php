...
//                'rewrite' => array('slug' => 'lc-rental'),
        ...
        function add_rentals_inner_meta_box( $post ) {
            ...
            <div class="lc-rentals__field-container">
                ...
                <div class="lc-rentals__field-container-checkboxes">
                    ...
                    <div class="lc-rentals__field-container-checkboxes-item">
                        <label for="garden"><?php esc_html_e('Garden: ', 'lc-rentals'); ?></label>
                        <?php
                        $checked = get_post_meta( $post->ID, 'garden', true ) == '1' ? 'checked' : '';
                        echo '<input type="checkbox" class="checkbox" id="garden" name="garden" ' . $checked . ' />';
                        ?>
                    </div>
                    <div class="lc-rentals__field-container-checkboxes-item">
                        <label for="mountain"><?php esc_html_e('Mountain View: ', 'lc-rentals'); ?></label>
	                    <?php
	                    $checked = get_post_meta( $post->ID, 'mountain', true ) == '1' ? 'checked' : '';
	                    echo '<input type="checkbox" class="checkbox" id="mountain" name="mountain" ' . $checked . ' />';
	                    ?>
                    </div>
                    <div class="lc-rentals__field-container-checkboxes-item">
                    ...
                    <div class="lc-rentals__field-container-checkboxes-item">
                        <label for="drying-rack"><?php esc_html_e('Drying Rack: ', 'lc-rentals'); ?></label>
	                    <?php
	                    $checked = get_post_meta( $post->ID, 'drying-rack', true ) == '1' ? 'checked' : '';
	                    echo '<input type="checkbox" class="checkbox" id="drying-rack" name="drying-rack" ' . $checked . ' />';
	                    ?>
                    </div>
                    <div class="lc-rentals__field-container-checkboxes-item">
                    ...
                    <div class="lc-rentals__field-container-checkboxes-item">
                        <label for="electric-stove"><?php esc_html_e('Electric Stove: ', 'lc-rentals'); ?></label>
	                    <?php
	                    $checked = get_post_meta( $post->ID, 'electric-stove', true ) == '1' ? 'checked' : '';
	                    echo '<input type="checkbox" class="checkbox" id="electric-stove" name="electric-stove" ' . $checked . ' />';
	                    ?>
                    </div>
                    <div class="lc-rentals__field-container-checkboxes-item">
                        <label for="oven"><?php esc_html_e('Oven: ', 'lc-rentals'); ?></label>
	                    <?php
	                    $checked = get_post_meta( $post->ID, 'oven', true ) == '1' ? 'checked' : '';
	                    echo '<input type="checkbox" class="checkbox" id="oven" name="oven" ' . $checked . ' />';
	                    ?>
                    </div>
                    <div class="lc-rentals__field-container-checkboxes-item">
                        <label for="kettle"><?php esc_html_e('Hot Water Kettle: ', 'lc-rentals'); ?></label>
	                    <?php
	                    $checked = get_post_meta( $post->ID, 'kettle', true ) == '1' ? 'checked' : '';
	                    echo '<input type="checkbox" class="checkbox" id="kettle" name="kettle" ' . $checked . ' />';
	                    ?>
                    </div>
                    <div class="lc-rentals__field-container-checkboxes-item">
                        <label for="refrigerator"><?php esc_html_e('Refrigerator: ', 'lc-rentals'); ?></label>
	                    <?php
	                    $checked = get_post_meta( $post->ID, 'refrigerator', true ) == '1' ? 'checked' : '';
	                    echo '<input type="checkbox" class="checkbox" id="refrigerator" name="refrigerator" ' . $checked . ' />';
	                    ?>
                    </div>
                    <div class="lc-rentals__field-container-checkboxes-item">
                        <label for="microwave"><?php esc_html_e('Microwave: ', 'lc-rentals'); ?></label>
	                    <?php
	                    $checked = get_post_meta( $post->ID, 'microwave', true ) == '1' ? 'checked' : '';
	                    echo '<input type="checkbox" class="checkbox" id="microwave" name="microwave" ' . $checked . ' />';
	                    ?>
                    </div>
                    <div class="lc-rentals__field-container-checkboxes-item">
                    ...
                    <div class="lc-rentals__field-container-checkboxes-item">
                        <label for="hdtv"><?php esc_html_e('HDTV With Netflix: ', 'lc-rentals'); ?></label>
	                    <?php
	                    $checked = get_post_meta( $post->ID, 'hdtv', true ) == '1' ? 'checked' : '';
	                    echo '<input type="checkbox" class="checkbox" id="hdtv" name="hdtv" ' . $checked . ' />';
	                    ?>
                    </div>
                    <div class="lc-rentals__field-container-checkboxes-item">
                        <label for="books"><?php esc_html_e('Books & Reading Materials: ', 'lc-rentals'); ?></label>
	                    <?php
	                    $checked = get_post_meta( $post->ID, 'books', true ) == '1' ? 'checked' : '';
	                    echo '<input type="checkbox" class="checkbox" id="books" name="books" ' . $checked . ' />';
	                    ?>
                    </div>
                    <div class="lc-rentals__field-container-checkboxes-item">
                        <label for="fireplace"><?php esc_html_e('Fireplace: ', 'lc-rentals'); ?></label>
	                    <?php
	                    $checked = get_post_meta( $post->ID, 'fireplace', true ) == '1' ? 'checked' : '';
	                    echo '<input type="checkbox" class="checkbox" id="fireplace" name="fireplace" ' . $checked . ' />';
	                    ?>
                    </div>
                    <div class="lc-rentals__field-container-checkboxes-item">
                    ...
                    <div class="lc-rentals__field-container-checkboxes-item">
                        <label for="hot-water"><?php esc_html_e('Hot Water: ', 'lc-rentals'); ?></label>
	                    <?php
	                    $checked = get_post_meta( $post->ID, 'hot-water', true ) == '1' ? 'checked' : '';
	                    echo '<input type="checkbox" class="checkbox" id="hot-water" name="hot-water" ' . $checked . ' />';
	                    ?>
                    </div>
                    <div class="lc-rentals__field-container-checkboxes-item">
                        <label for="outdoor-shower"><?php esc_html_e('Outdoor Shower: ', 'lc-rentals'); ?></label>
	                    <?php
	                    $checked = get_post_meta( $post->ID, 'outdoor-shower', true ) == '1' ? 'checked' : '';
	                    echo '<input type="checkbox" class="checkbox" id="outdoor-shower" name="outdoor-shower" ' . $checked . ' />';
	                    ?>
                    </div>
                    <div class="lc-rentals__field-container-checkboxes-item">
                        <label for="hammock"><?php esc_html_e('Hammock: ', 'lc-rentals'); ?></label>
	                    <?php
	                    $checked = get_post_meta( $post->ID, 'hammock', true ) == '1' ? 'checked' : '';
	                    echo '<input type="checkbox" class="checkbox" id="hammock" name="hammock" ' . $checked . ' />';
	                    ?>
                    </div>
                    <div class="lc-rentals__field-container-checkboxes-item">
                        <label for="bbq"><?php esc_html_e('BBQ: ', 'lc-rentals'); ?></label>
	                    <?php
	                    $checked = get_post_meta( $post->ID, 'bbq', true ) == '1' ? 'checked' : '';
	                    echo '<input type="checkbox" class="checkbox" id="bbq" name="bbq" ' . $checked . ' />';
	                    ?>
                    </div>
                    <div class="lc-rentals__field-container-checkboxes-item">
                        <label for="shampoo"><?php esc_html_e('Shampoo & Soap: ', 'lc-rentals'); ?></label>
	                    <?php
                    ...
                    <div class="lc-rentals__field-container-checkboxes-item">
                        <label for="clothing-storage"><?php esc_html_e('Clothing Storage: ', 'lc-rentals'); ?></label>
	                    <?php
	                    $checked = get_post_meta( $post->ID, 'clothing-storage', true ) == '1' ? 'checked' : '';
	                    echo '<input type="checkbox" class="checkbox" id="clothing-storage" name="clothing-storage" ' . $checked . ' />';
	                    ?>
                    </div>
                    <div class="lc-rentals__field-container-checkboxes-item">
        ...
        function lc_rentals_save_post_data( $post_id ) {
	        ...
	        $checkbox_fields = ['jacuzzi', 'pool', 'gym', 'kids', 'ac', 'ceiling-fan', 'amenities', 'images', 'essentials', 'cleaning-products', 'cooking-basics', 'workspace', 'garden', 'mountain', 'dishes', 'dryer', 'washing-machine', 'drying-rack', 'clothing-storage', 'hair-dryer', 'heating', 'electric-stove', 'kitchen', 'oven', 'bbq', 'kettle', 'microwave', 'refrigerator', 'fireplace', 'tv', 'hdtv', 'books', 'dishwasher', 'wifi', 'bathtub', 'shower', 'hot-water', 'outdoor-shower', 'hammock', 'shampoo', 'hangers', 'iron', 'safe-box'];
