<div class="lc-datepicker lc-datepicker-check-out">
	<div id="datepickerCheckOut" class="lc-datepicker check-out">
		...
		<div role="dialog" aria-modal="true" class="lc-datepicker-check-out-modal" aria-label="<?php esc_attr_e('Choose check-out date', 'lc-rentals'); ?>">
			<div class="lc-datepicker-header">
				<button type="button" class="prev-month" aria-label="<?php esc_attr_e('Previous month', 'lc-rentals'); ?>"><?php echo wp_get_attachment_image(169, 'full') ?></button>
				<div id="grid-label" class="month-year" aria-live="polite"></div>
				<button type="button" class="next-month" aria-label="<?php esc_attr_e('Next month', 'lc-rentals'); ?>"><?php echo wp_get_attachment_image(42, 'full') ?></button>
			</div>
