...
function send_email_to_subscribers($post_id) {
	...
	$message = '<html><body>';
	$message .= '<h1>A new blog post has been created:</h1>';
	...
	$message .= '<p><a href="http://localhost:10004/lc-unsubscribe?unsubscribe=1&email=' . $subscriber->post_title . '">Unsubscribe</a></p>';
	$message .= '</body></html>';
