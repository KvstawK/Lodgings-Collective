...
function wpbs_get_days_first_letters($language_code = 'en')
{
    ...
    $days_first_letters = array(
        ...
        'ar' => array('الأثنين', 'الثلاثاء', 'الأربعاء', 'الخميس', 'الجمعة', 'السبت', 'الأحد'), /* Arabic */
        ...
        'vi' => array('T2', 'T3', 'T4', 'T5', 'T6', 'T7', 'CN'), /* Vietnamese */
     ...
     *
     */
    $days_first_letters = apply_filters('wpbs_get_days_first_letters', $days_first_letters);
...
function wpbs_get_month_name($month, $language_code = 'en')
{
    ...
    $month_names = array(
        ...
        /* Arabic */
        'ar' => array('يناير', 'فبراير', 'مارس', 'أبريل', 'مايو', 'يونيو', 'يوليه', 'أغسطس', 'سبتمبر', 'أكتوبر', 'نوفمبر', 'ديسمبر'),
        ...
        /* Hebrew */
        'il' => array('ינואר', 'פברואר', 'מרץ', 'אפריל', 'מאי', 'יוני', 'יולי', 'אוגוסט', 'ספטמבר', 'אוקטובר', 'נובמבר', 'דצמבר'),
        ...
        /* Vietnamese */
        'vi' => array('tháng một', 'tháng hai', 'tháng ba', 'tháng tư', 'tháng năm', 'tháng sáu', 'tháng bảy', 'tháng tám', 'tháng chín', 'tháng mười', 'tháng mười một', 'tháng mười hai'),
     ...
     *
     */
    $month_names = apply_filters('wpbs_get_month_name', $month_names);
...
/**
 * Get the site's language if a translation plugin is installed.
 *
 */
function wpbs_get_site_language()
{
