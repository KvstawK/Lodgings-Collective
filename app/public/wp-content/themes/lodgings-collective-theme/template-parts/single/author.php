<div class="blog__single-author">
    <h2 class="screen-reader-text"><?php esc_html_e('About The Author', 'lodgings_collective_theme'); ?></h2>
    <?php
    ...
    <div class="c-post-author__content">
        ...
        <div class="c-post-author__info">
            <a href="<?php echo esc_url($author_posts_url); ?>">
                <?php
                printf(esc_html(_n('%s post', '%s posts', $author_posts, 'lodgings_collective_theme')), number_format_i18n($author_posts));
                ?>
            </a>
        </div>
