...
<section class="page-banner">
	<?php echo wp_get_attachment_image(431, 'full') ?>
	<div class="page-banner-text">
		<h1><?php esc_html_e('Villas & Apartments In Heraklion Crete, Greece', 'lodgings_collective_theme'); ?></h1>
		<h2><?php esc_html_e('Check our guide and the availability of our short-term rentals in Heraklion.', 'lodgings_collective_theme'); ?></h2>
	</div>
</section>
